        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#home" className="text-muted-foreground hover-link">Home</a></li>
              <li><a href="#about" className="text-muted-foreground hover-link">About</a></li>
              <li><a href="#portfolio" className="text-muted-foreground hover-link">Portfolio</a></li>
              <li><a href="#services" className="text-muted-foreground hover-link">Services</a></li>
              <li><a href="#team" className="text-muted-foreground hover-link">Team</a></li>
              <li><a href="#contact" className="text-muted-foreground hover-link">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-muted-foreground">Monday - Friday: 9am - 6pm</li>
              <li className="text-muted-foreground">Saturday: By appointment</li>
